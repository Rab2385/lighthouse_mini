...
class GoodThingsPage extends StatefulWidget {
  ...
  @override
  State<GoodThingsPage> createState() =>
      _GoodThingsPageState();
}

class _GoodThingsPageState
    extends State<GoodThingsPage> {
  ...
  Future<void> _editEntry(
    ...
    await widget.controller.updateGoodThing(
      id: entry.id,
      text: newText,
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return AnimatedBuilder(
      ...
      builder: (context, child) {
        final searchResults = widget.controller
            .searchGoodThings(_searchQuery);
        ...
        return Column(
          children: [
            MonthHeader(
              ...
              onNextMonth:
                  _canShowNextMonth ? _showNextMonth : null,
...
class _SearchResults extends StatelessWidget {
  ...
  final LighthouseController controller;
  final Future<void> Function(GoodThing entry)
      onEdit;
  ...
  Widget build(BuildContext context) {
    ...
    return ListView.separated(
      ...
      itemBuilder: (context, index) {
        ...
        final isAhead =
            entry.date.isAfter(controller.today);
...
class _QuickEntryField extends StatefulWidget {
  ...
  @override
  State<_QuickEntryField> createState() =>
      _QuickEntryFieldState();
}

class _QuickEntryFieldState
    extends State<_QuickEntryField> {
  ...
  Future<void> _submit() async {
    ...
    await widget.controller.addGoodThing(
      date: widget.date,
      text: text,
    );
  ...
  Widget build(BuildContext context) {
    final suggestions = _hasFocus
        ? widget.controller.suggestionsFor(
            _query,
          )
        : const <String>[];
...
class _FutureLimitMessage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final day =
        maximumFutureDate.day.toString().padLeft(2, '0');
    final month = maximumFutureDate.month
        .toString()
        .padLeft(2, '0');
